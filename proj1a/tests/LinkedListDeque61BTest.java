...
public class LinkedListDeque61BTest {
    ...
    @Test
    /** This test tests empty list and non-empty list. */
    ...
    @Test
    /** This test tests empty list with two special cases
     * and non-empty list with two special cases and some normal cases. */
	...
	assertThat(lld1.getRecursive(-12)).isEqualTo(null);
    }

    @Test
    /** This test tests empty list with one assertThat statement
     *  and non-empty list with three assertThat statements. */
