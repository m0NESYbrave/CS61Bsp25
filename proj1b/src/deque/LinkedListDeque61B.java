...
public class LinkedListDeque61B<T> implements Deque61B<T> {
    ...
    private class LinkedListDequeIterator implements Iterator<T> {
        ...
        LinkedListDequeIterator() {
            wizPos = new Node(null, null, sentinel);
        }

        @Override
        public boolean hasNext() {
	    return wizPos.next.next != sentinel;
	}

        @Override
        public T next() {
            wizPos.next = wizPos.next.next;
            return wizPos.next.item;
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof LinkedListDeque61B<?> otherDeque) {
    ...
    /** Test for object methods simply. */
